...
1. **Implementer-{module}** for each module/workstream
   ...
   - Write TypeScript type annotations on all functions
   - Run bunx eslint --fix after each file change
