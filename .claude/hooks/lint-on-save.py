#!/usr/bin/env python3
"""
Post-tool hook: Run formatter and linter on TypeScript/JavaScript files after Edit/Write.

Triggered after Edit or Write tools modify files.
Runs prettier (format) and eslint (lint + auto-fix) on target files.
"""
...
# Target file extensions for TypeScript/JavaScript projects
...
def is_target_file(path: str) -> bool:
    ...
    return path.endswith(TARGET_EXTENSIONS)
